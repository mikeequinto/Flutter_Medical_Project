...
import 'package:popi/Screens/Account_Creation/AccountForms/diplomas_form.dart';
...
class CompteDiplomesScreen extends StatelessWidget {
  @override
            ...
            Container(
              ...
              child: Padding(
                  ...
                  child: Align(
                    ...
                    child: Text("Diplômes", style: screenTitle),
                  )),
            ),
            Container(
